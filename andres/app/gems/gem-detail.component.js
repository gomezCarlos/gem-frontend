...
var GemDetailComponent = (function () {
    ...
    GemDetailComponent.prototype.ngOnInit = function () {
        ...
        this.param = this.route.params.subscribe(function (parameter) {
            ...
            if (id) {
                _this.gemService
                    .getById(id)
                    .subscribe(function (gem) { return _this.gem = gem; }, function (error) { return _this.error = error; });
            }
            else {
    ...
    GemDetailComponent.prototype.save = function () {
        ...
        this.gemService.save(this.gem)
            .subscribe(function (gem) { _this.gem = gem; _this.router.navigate(["/gems"]); }, function (error) { return _this.error = error; });
    };
